    ...
    <nav class="col-sm-2 bg-light sidebar py-3"><!-- start sidebar-->
      <div class="sidebar-sticky">
        <ul class="nav flex-column" style="height:100vh">
          ...
          <li class="nav-item"><a class="nav-link " href="manage_order.php">
          <i class="fas fa-user"> </i>  Manage Order</a></li>
          <li class="nav-item"><a class="nav-link " href="table_rev.php">
          <i class="fas fa-table"> </i>  Table Reservation</a></li>
          <li class="nav-item"><a class="nav-link " href="manage_menu.php">
          <i class="fas fa-list"> </i>  Menu</a></li>
          
          <li class="nav-item"><a class="nav-link " href="changepwd_s.php">
